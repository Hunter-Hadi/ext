 ...
 */
export const CHROME_EXTENSION_DB_STORAGE_SAVE_KEY = `CHROME_EXTENSION_${APP_ENV}_CLIENT_SAVE_KEY`
export const CHROME_EXTENSION_LOCAL_STORAGE_SAVE_KEY = `CHROME_EXTENSION_${APP_ENV}_LOCAL_STORAGE_SAVE_KEY`
