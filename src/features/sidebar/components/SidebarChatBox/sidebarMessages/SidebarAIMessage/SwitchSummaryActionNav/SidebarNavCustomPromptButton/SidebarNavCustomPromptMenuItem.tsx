...
import RenderCustomPromptMenuList, {
  checkIsValidGroup,
} from './RenderCustomPromptMenuList'

export const CustomPromptMenuListIcon = styled(
  ({ children, ...props }: ListItemIconProps) => (
...
export const CustomPromptMenuListItem = styled(
  ({ children, ...props }: ComponentProps<typeof MenuItem>) => (
...
const SidebarNavCustomPromptMenuItem: FC<
  ISidebarNavCustomPromptMenuItemType
> = (props) => {
