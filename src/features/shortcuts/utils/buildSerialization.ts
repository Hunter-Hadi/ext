...
const valueMap = [
  {
    ...
    validator: (item: Value): boolean => typeof item === typeof '',
  },
  {
    // Object
    builder: (val: Value, key?: string): WFDictionaryFieldValueItem => {
  ...
  },
  {
    ...
    validator: (item: Value): boolean => Array.isArray(item),
  },
  {
    // Number
    builder: (val: Value, key?: string): WFDictionaryFieldValueItem => {
    ...
    validator: (item: Value): boolean => typeof item === typeof 0,
  },
  {
    // Boolean
    builder: (val: Value, key?: string): WFDictionaryFieldValueItem => {
    ...
    validator: (item: Value): boolean => typeof item === typeof true,
  },
]
