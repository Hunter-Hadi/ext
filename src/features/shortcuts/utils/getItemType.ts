...
const itemTypeMap = [
  {
    ...
    validator: (item: itemType): boolean => typeof item === typeof '',
  },
  {
  ...
  },
  {
    ...
    validator: (item: itemType): boolean => Array.isArray(item),
  },
  {
    itemType: 3 as WFItemType, // Number
    validator: (item: itemType): boolean => typeof item === typeof 0,
  },
  {
    itemType: 4 as WFItemType, // Boolean
    validator: (item: itemType): boolean => typeof item === typeof true,
  },
]

export const getItemType = (item: itemType): WFItemType => {
