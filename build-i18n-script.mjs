...
/**
 * 更新i18n
 * @param forceUpdateKeys 强制更新的key
 * @param retryLanguageCodes 重试的语言包
 * @return {Promise<void>}
 */
export const buildI18n = async  (forceUpdateKeys = [], retryLanguageCodes = []) => {
  // 美国、日本、韩国、新加坡
  ...
  await updateKeys(forceUpdateKeys, forceUpdateKeys.length > 0, retryLanguageCodes)
