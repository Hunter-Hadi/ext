...
;(function (factory, root) {
    ...
    function createPrototypeRange(constructor, boundaryUpdater) {
      ...
      util.extend(constructor.prototype, {
        ...
        parentElement: function () {
          ...
          return parentNode
            ? getElementAncestor(this.commonAncestorContainer, true)
            : null
        },
      })
  ...
  api.createCoreModule(
    ...
    function (api, module) {
      ...
      var selectionHasSetBaseAndExtent = isHostMethod(
        testSelection,
        'setBaseAndExtent',
      )
      ...
      if (
        ...
        ;(function () {
          ...
          console.log('IS_BLACK_LIST_ORIGIN', IS_BLACK_LIST_ORIGIN)
          if (sel && !IS_BLACK_LIST_ORIGIN) {
      ...
      if (selectionHasSetBaseAndExtent) {
        selProto.setBaseAndExtent = function (
          anchorNode,
          anchorOffset,
          focusNode,
          focusOffset,
        ) {
          this.nativeSelection.setBaseAndExtent(
            anchorNode,
            anchorOffset,
            focusNode,
            focusOffset,
