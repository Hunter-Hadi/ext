      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a short summarized version of my text. Use the same language variety (or dialect) as the original text. Keep the meaning the same. Ensure that the revised content has significantly fewer characters than the original text, and no more than 100 words, the fewer the better. Only reply to the summary, and nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will analyze it and output the key takeaways in bullet point format. Use the same language variety (or dialect) as the original text. Keep the meaning the same. Ensure that the revised content has significantly fewer characters than the original text, and no more than 100 words, the fewer the better. Only reply to the summary, and nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, give me the key takeaways from the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will find action items from it and output them in bullet point format. Identify only the action items that need the reader to take action, and exclude action items requiring action from anyone other than the reader. Use the same language variety (or dialect) as the original text. Only reply to the bullet points of action items you find, and nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, find action items from the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a much shorter version of my text. Use the same language variety (or dialect) as the original text. Keep the meaning the same. Only reply to the re-written text, nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a much longer version of my text. Use the same language variety (or dialect) as the original text. Keep the meaning the same. Only reply to the re-written text, nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
