      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a short summarized version of my text. Keep the language the same. Keep the meaning the same. Ensure that the revised content has significantly fewer characters than the original text, and no more than 100 words, the fewer the better. Only reply to the summary, and nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will analyze it and output the key takeaways in bullet point format. Keep the language the same. Keep the meaning the same. Ensure that the revised content has significantly fewer characters than the original text, and no more than 100 words, the fewer the better. Only reply to the summary, and nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, give me the key takeaways from the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a much shorter version of my text. Keep the language the same. Keep the meaning the same. Only reply to the re-written text, nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
      ...
      actions: [
        {
          ...
          parameters: {
            template:
              'Ignore all previous instructions.\n\nI will give you text content, you will rewrite it and output that in a much longer version of my text. Keep the language the same. Keep the meaning the same. Only reply to the re-written text, nothing else. Do not write explanations. Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference. Do not use generic filler phrases. Get to the point precisely and accurately. Do not explain what and why, just give me your best possible result.\n\nNow, using the concepts above, re-write the following text:\n"""\n{{HIGHLIGHTED_TEXT}}\n"""',
          },
        },
        {
          type: 'ASK_CHATGPT',
