...
const SettingPromptsWritingAssistantCard: FC = () => {
  ...
  const radioCardOptions = useMemo(
    () => [
      {
        label: t(
          'settings:feature_card__prompts__instant_reply__quick_reply_radio_title',
        ),
      ...
      {
        label: t(
          'settings:feature_card__prompts__instant_reply__edit_or_review_draft_radio_title',
        ),
      ...
      {
        label: t(
          'settings:feature_card__prompts__instant_reply__quick_compose_radio_title',
        ),
  ...
  }, [originalTreeData, contextMenuSearchTextWithCurrentLanguage, position])
      ...
      >
        ...
        >
          <Stack height={'100%'}>
            ...
            <InputAssistantButtonExhibit
              highlight={editButtonKey === 'inputAssistantRefineDraftButton'}
            />
            <SettingPromptsMenuPanel
              ...
              sx={{
                width:
                  editButtonKey === 'inputAssistantRefineDraftButton'
                    ? 'calc(50% - 12px)'
                    : 'calc(50% + 12px)',
                mt: '4px',
                ml:
