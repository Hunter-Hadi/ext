  ...
  var e = {
      ...
      2585: function (e, t, n) {
        ...
        var o = 200,
          ...
          L = /^(?:0|[1-9]\d*)$/,
          I = {}
        ;(I[c] = I['[object Array]'] = I[O] = I[S] = I[s] = I[u] = I[j] = I[
          x
        ] = I[E] = I[_] = I[k] = I[p] = I[d] = I[v] = I[h] = I[m] = I[b] = I[
          g
        ] = I[A] = I[P] = I[C] = I[T] = !0),
  ...
  !(function () {
              ...
              value: function (e, t) {
                ...
                i && window.removeEventListener('message', i),
                  ...
                  window.addEventListener(
                    'message',
                    window[R][this.config.publicKey].listener,
                  )
              },
            },
            {
    ...
    Pe.on('challenge iframe', function (e) {
      ...
      if (Je.frame) {
        ...
        var p = !1
        t &&
          t !== Je.frame.style.width &&
          ((Je.frame.style.width = t), (p = !0)),
          n &&
            n !== Je.frame.style.height &&
            ((Je.frame.style.height = n), (p = !0)),
          Je.mode === a &&
            (r &&
            ...
            i &&
              i !== Je.frame.style['max-width'] &&
              ((Je.frame.style['max-width'] = i), (p = !0)),
            c &&
          ...
          document.activeElement !== Je.element &&
            !1 === Je.mode &&
            Je.frame.focus()
      }
    })
                  ...
                  return Object.keys(le).reduce(function (t, n) {
                    ...
                    if ('boolean' === o.type)
                      return oe(
                        oe({}, t),
                        {},
                        ae({}, n, 'boolean' == typeof r ? r : o.default),
                      )
                    var i =
    ...
    var dt = function (e) {
      ...
      At = function () {
        ...
        return (
          e.setAttribute('aria-hidden', !0), e.setAttribute('class', dt(ut)), e
        )
      },
      Pt = function () {
        var e,
      ...
      Tt = function () {
        !(function (e) {
          ...
          if (B(Je.element, 'children', []).length < 1) {
            ...
            Qe(Je.frame, l),
              Je.isActive ||
                ((Je.frame.style.width = 0), (Je.frame.style.height = 0))
        })({
          host: lt,
      ...
      Ft = function () {
        return B(vt, 'config.mode') === a
          ? ((vt.container = document.querySelector(
              B(vt, 'config.selector', ''),
            )),
            void (
              vt.container &&
              (vt.container.contains(vt.element) ||
                (vt.container.appendChild(vt.element), Tt()))
            ))
    ...
    Pe.on(w, function () {
      ...
      Pe.on(x, function (e) {
        ...
        ;(vt.isReady = !0),
          (vt.token = t),
          vt.isHidden ||
            ((vt.isActive = !0), Tt(), pt.timerEnd(I), Ct(h, new kt(vt)))
      }),
