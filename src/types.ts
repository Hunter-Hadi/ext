...
export const CHROME_EXTENSION_LOCAL_STOP_KEEP_CHAT_IFRAME_TIME_STAMP_SAVE_KEY = `CHROME_EXTENSION_${process.env.APP_ENV}_STOP_KEEP_CHAT_IFRAME_TIME_STAMP_SAVE_KEY`
